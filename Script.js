...
async function fetchQuestions() {
  ...
  questions = questions.slice(0, 5); // Adjusted to 5 questions
}
...
function displayQuestion() {
  ...
  questionNumberElement.innerHTML = `<strong>Question ${currentQuestionIndex + 1} of 5</strong>`; // Updated to 5
...
function nextQuestion() {
  ...
  if (currentQuestionIndex >= 5) { // Updated to 5
    // Game over, display final score and share button
    if (score < 3) {
      resultElement.innerHTML = `Game Over! Your final score is ${score}/5 &#129318;`;
